        ...
        <div className="auth-content-box">
          ...
          <form onSubmit={handleSubmit} className="auth-vertical-form">
            <div className="form-input-group">
              <label htmlFor="v-email" className="form-label-text">
                Your Email Address
              </label>
              <input
                type="email"
            ...
            <div className="form-input-group">
              <label htmlFor="v-password" className="form-label-text">
                Your Password
              </label>
              <input
                type="password"
          ...
          <p className="auth-switch-text">
            ...
            <Link to="/register-volunteer" className="auth-inline-link">
              Register Now
            </Link>
          </p>
        </div>
